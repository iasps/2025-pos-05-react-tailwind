        ...
        <main className="flex-1 p-6">
          ...
          <div className='grid grid-cols-3 gap-4 mt-4'>
            <a href="#" className='bg-white/5 group rounded flex items-center gap-4 overflow-hidden hover:bg-white/10 transition-colors'>
              <img src="/album.jpg" width={104} height={104} alt="Capa do Álbum da Inês Brasil"/>
              <strong>Inês Brasil - Undererê</strong>
          ...
          <h2 className='font-semibold text-2xl mt-10'>Made for Iasmim Paula</h2>

          <div className='grid grid-cols-8 gap-4 mt-4'>
            <a href="#" className='bg-white/5 p-3 flex flex-col gap-2 rounded-md hover:bg-white/10'>
              <img src="/album.jpg" className="w-full" width={120} height={120} alt="Capa do Álbum da Inês Brasil"/>
              <strong className='font-semibold'>Daily Mix 1</strong>
              <span className='text-sm text-zinc-600'>Inês Brasil</span>
            </a>
            <a href="#" className='bg-white/5 p-3 flex flex-col gap-2 rounded-md hover:bg-white/10'>
              <img src="/album.jpg" className="w-full" width={120} height={120} alt="Capa do Álbum da Inês Brasil"/>
              <strong className='font-semibold'>Daily Mix 1</strong>
