...
export function Footer(){
    return (
        ...
        <div className='flex items-center gap-3'>
          <img src="/album.jpg" width={56} height={56} alt="Capa do album da Bnada Calcinha Preta"/>
          <div className='flex flex-col'>
            <strong className='font-normal'>Undererê</strong>
            <span className='text-xs text-zinc-400'>Inês Brasil</span>
          </div>
        </div>
